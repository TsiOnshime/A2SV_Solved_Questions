...
## Medium
Given an array of positive integers arr[] and a value sum, find if there is a subset of arr[] with sum equal to given sum.&nbsp;Examples:Input: arr[] = [3, 34, 4, 12, 5, 2], sum = 9Output: true&nbsp;
